function RM = locoresponsematrixFull(RINGData, BPMData, CMData, varargin)
...
%  3. TH - 25/1/21 added fixed momentum calculation for non-correctorpass elemets
    ...
    elseif strcmpi(ClosedOrbitType, 'FixedMomentum')
        ...
        for i = 1:NHC
            switch ATRING{CMData.HCMIndex(i)}.PassMethod
				...
				case {'StrMPoleSymplectic4Pass','StrMPoleSymplectic4RadPass','BndMPoleSymplectic4Pass','BndMPoleSymplectic4RadPass'}
		
					ElLength      = ATRING{CMData.HCMIndex(i)}.Length;
					KickAngle0(1) = ATRING{CMData.HCMIndex(i)}.PolynomB(1) * ElLength;
					KickAngle0(2) = ATRING{CMData.HCMIndex(i)}.PolynomA(1) * ElLength;
					
					if strcmpi(ResponseMatrixMeasurement, 'Bidirectional')
						% Notice sign change!
						ATRING{CMData.HCMIndex(i)}.PolynomB(1) = (KickAngle0(1) - CMData.HCMKicks(i)/2                      ) / ElLength;
						ATRING{CMData.HCMIndex(i)}.PolynomA(1) = (KickAngle0(2) - CMData.HCMKicks(i)*CMData.HCMCoupling(i)/2) / ElLength;
						ORBITPLUS = findorbit6(ATRING,BPMData.BPMIndex);
						
						ATRING{CMData.HCMIndex(i)}.PolynomB(1) = (KickAngle0(1) + CMData.HCMKicks(i)/2                      ) / ElLength;
						ATRING{CMData.HCMIndex(i)}.PolynomA(1) = (KickAngle0(2) + CMData.HCMKicks(i)*CMData.HCMCoupling(i)/2) / ElLength;
						ORBITMINUS = findorbit6(ATRING,BPMData.BPMIndex);
					else
						ATRING{CMData.HCMIndex(i)}.PolynomB(1) = (KickAngle0(1) - CMData.HCMKicks(i)                      ) / ElLength;
						ATRING{CMData.HCMIndex(i)}.PolynomA(1) = (KickAngle0(2) - CMData.HCMKicks(i)*CMData.HCMCoupling(i)) / ElLength;
						ORBITPLUS = findorbit6(ATRING,BPMData.BPMIndex);
						
						ATRING{CMData.HCMIndex(i)}.PolynomB(1) = KickAngle0(2);
						ATRING{CMData.HCMIndex(i)}.PolynomA(1) = KickAngle0(1);
						ORBITMINUS = findorbit6(ATRING,BPMData.BPMIndex);
					end
					
					ATRING{CMData.HCMIndex(i)}.PolynomB(1) = KickAngle0(1) / ElLength;
					ATRING{CMData.HCMIndex(i)}.PolynomA(1) = KickAngle0(2) / ElLength;
        ...
        for i = 1:NVC
            switch ATRING{CMData.VCMIndex(i)}.PassMethod
				...
				case {'StrMPoleSymplectic4Pass','StrMPoleSymplectic4RadPass','BndMPoleSymplectic4Pass','BndMPoleSymplectic4RadPass'}
					...
					ElLength      = ATRING{CMData.VCMIndex(i)}.Length;
					KickAngle0(1) = ATRING{CMData.VCMIndex(i)}.PolynomB(1) * ElLength;
					KickAngle0(2) = ATRING{CMData.VCMIndex(i)}.PolynomA(1) * ElLength;
					
					if strcmpi(ResponseMatrixMeasurement, 'Bidirectional')
                        ATRING{CMData.VCMIndex(i)}.PolynomB(1) = (KickAngle0(1) + CMData.VCMKicks(i)*CMData.VCMCoupling(i)/2) / ElLength;
                        ATRING{CMData.VCMIndex(i)}.PolynomA(1) = (KickAngle0(2) + CMData.VCMKicks(i)/2                      ) / ElLength;
                        ORBITPLUS = findorbit6(ATRING,BPMData.BPMIndex);
						...
						ATRING{CMData.VCMIndex(i)}.PolynomB(1) = (KickAngle0(1) + CMData.VCMKicks(i)*CMData.VCMCoupling(i)) / ElLength;
						ATRING{CMData.VCMIndex(i)}.PolynomA(1) = (KickAngle0(2) + CMData.VCMKicks(i)                      ) / ElLength;
						ORBITPLUS = findorbit6(ATRING,BPMData.BPMIndex);

                        ATRING{CMData.VCMIndex(i)}.PolynomB(1) = KickAngle0(1);
                        ATRING{CMData.VCMIndex(i)}.PolynomA(1) = KickAngle0(2);
                        ORBITMINUS = findorbit6(ATRING,BPMData.BPMIndex);
					end

					ATRING{CMData.VCMIndex(i)}.PolynomB(1) = KickAngle0(1) / ElLength;
					ATRING{CMData.VCMIndex(i)}.PolynomA(1) = KickAngle0(2) / ElLength;
